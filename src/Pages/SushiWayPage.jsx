  ...
  return (
    <div className="w-full md:max-w-[1360px] px-2 m-auto md:mt-8">
      <div className="flex items-center text-base mt-2">
        <Link to="/">Trang chủ</Link> <span className="mx-1">/</span>{" "}
        <p className="text-[#848484]">Chuyên mục Shushiway</p>
      </div>
      <h1 className="block mt-5 mb-3 text-2xl text-[#B61C0B]">
        Chuyên mục Sushiway
      </h1>
...
export default withLayout(SushiWayPage);
