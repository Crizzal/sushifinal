      ...
      <div className="md:w-1/2 mt-8 px-4 md:px-0">
        ...
        <div>
          ...
          <form action="">
            <input
              type="text"
              className="border border-black rounded px-2 outline-none block w-full mb-4 py-1"
            ...
            <textarea
              ...
              cols="30"
              rows="10"
              className="border border-black rounded px-2 outline-none block w-full mb-4"
              placeholder="Mô tả"
            ></textarea>
            <button
              className="w-full bg-[#B61C0B] text-[#212529] text-sm py-[3px] font-semibold rounded border border-black hover:text-white hover:bg-[#921609] duration-300 "
              type="submit"
            >
              Gửi liên hệ của bạn
            </button>
